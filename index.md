...
venue: "Oxford"        # brief name of host site without address (e.g., "Euphoric State University")
address: "WIMM"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Nicki Gray"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
